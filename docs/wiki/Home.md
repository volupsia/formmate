...
| [Docker Deployment](./Docker-Deployment.md) | Deploy FormCMS with Docker (includes MCP server) |
| [Vite, React, and AI Agents](./Vite-React-Antigravity-Example.md) | Build full-stack apps with MCP tools and AI agents (Antigravity, Cursor, Codex) |
...
| Docker Deployment | DevOps, System Admins |
| Vite, React, and AI Agents | Frontend Devs, AI Agent Users |

## 🔗 Quick Links

- [Main README](../../README.md) - Quick start guide
- [Live Demo](https://formcms.com/mate) - Try FormCMS online
- [GitHub Repository](https://github.com/formcms/formmate) - Source code
