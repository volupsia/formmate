...
export interface SchemaDto {
    ...
    settings: {
        ...
        query?: QueryDto | null;
        page?: any | null; // Placeholder to avoid circular dependency with PageDto in mate.dto.ts if needed, but PageDto is usually in mate.dto
    };
}
...
export type SaveSchemaPayload = {
    ...
    description?: string;
    settings: {
        page: any; // Placeholder for PageDto
    };
};
